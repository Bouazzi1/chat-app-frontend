      ...
      return (
        <div className="flex justify-center items-center h-screen bg-background dark:bg-background-dark">
          <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-8 w-96 relative overflow-hidden">
            ...
            <h2 className="text-2xl font-bold mb-6 text-text dark:text-text-dark text-center relative z-10">Register</h2>
            <form onSubmit={handleSubmit} className="relative z-10">
              ...
              <div className="flex items-center justify-center mb-4">
                <button
                  className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-full focus:outline-none focus:shadow-outline flex items-center"
                  type="submit"
                >
                  Register Now
              ...
              <div className="text-center mt-4">
                <a href="/login" className="inline-block align-baseline font-bold text-sm text-primary hover:text-primary-dark">
                  Login
                </a>
              </div>
            </form>
